...
public class CriarPartidaGrupoD extends PrincipalActivity {
	...
	public void btnAvancar(View v) {
		...
		// adicionando partida19
		partidas.add(criarPartida(19, data1.getTime(), local1.getText()
				.toString(), spinner1.getSelectedItem().toString(), spinner2
				.getSelectedItem().toString()));
		// adicionando partida20
		partidas.add(criarPartida(20, data2.getTime(), local2.getText()
				.toString(), spinner3.getSelectedItem().toString(), spinner4
				.getSelectedItem().toString()));
		// adicionando partida21
		partidas.add(criarPartida(21, data3.getTime(), local3.getText()
				.toString(), spinner5.getSelectedItem().toString(), spinner6
				.getSelectedItem().toString()));
		// adicionando partida22
		partidas.add(criarPartida(22, data4.getTime(), local4.getText()
				.toString(), spinner7.getSelectedItem().toString(), spinner8
				.getSelectedItem().toString()));
		// adicionando partida23
		partidas.add(criarPartida(23, data5.getTime(), local5.getText()
				.toString(), spinner9.getSelectedItem().toString(), spinner10
				.getSelectedItem().toString()));
		// adicionando partida24
		partidas.add(criarPartida(24, data6.getTime(), local6.getText()
	...
	public void setData1(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener1,
	...
	public void setData2(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener2,
	...
	public void setData3(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener3,
	...
	public void setData4(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener4,
	...
	public void setData5(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener5,
	...
	public void setData6(View view) {
		new DatePickerDialog(CriarPartidaGrupoD.this, dataListener6,
