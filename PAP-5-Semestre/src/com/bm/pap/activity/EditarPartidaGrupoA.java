...
public class EditarPartidaGrupoA extends PrincipalActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_editar_partida_grupo_a);
		

		Bundle extra = getIntent().getBundleExtra("bundleEquipesSelecionadas");
		equipesSelecionadas = new ArrayList<Equipe>();
		Equipe brasil = new Equipe();
		brasil.setNome("BRASIL");
		equipesSelecionadas.add(brasil);
		
		Equipe japao = new Equipe();
		japao.setNome("JAPÃO");
		equipesSelecionadas.add(japao);
		
		Equipe mexico = new Equipe();
		mexico.setNome("MÉXICO");
		equipesSelecionadas.add(mexico);
		
		Equipe italia = new Equipe();
		italia.setNome("ITÁLIA");
		equipesSelecionadas.add(italia);
		
		Equipe espanha = new Equipe();
		espanha.setNome("ESPANHA");
		equipesSelecionadas.add(espanha);
		
		Equipe uruguai = new Equipe();
		uruguai.setNome("URUGUAI");
		equipesSelecionadas.add(uruguai);
		
		Equipe taiti = new Equipe();
		taiti.setNome("TAITI");
		equipesSelecionadas.add(taiti);
		
		Equipe nigeria = new Equipe();
		nigeria.setNome("NIGÉRIA");
		equipesSelecionadas.add(nigeria);
		...
		local1.setEnabled(false);
		local2.setEnabled(false);
		local3.setEnabled(false);
		local4.setEnabled(false);
		local5.setEnabled(false);
		local6.setEnabled(false);
	...
	public void btnAvancar(View v) {
		...
		Intent intent = new Intent(getBaseContext(), EditarPartidaGrupoB.class);
	...
	public void setData1(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener1,
	...
	public void setData2(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener2,
	...
	public void setData3(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener3,
	...
	public void setData4(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener4,
	...
	public void setData5(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener5,
	...
	public void setData6(View view) {
		new DatePickerDialog(EditarPartidaGrupoA.this, dataListener6,
