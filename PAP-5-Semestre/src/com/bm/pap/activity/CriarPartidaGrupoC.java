...
public class CriarPartidaGrupoC extends PrincipalActivity {
	...
	public void btnAvancar(View v) {
		...
		// adicionando partida13
		partidas.add(criarPartida(13, data1.getTime(), local1.getText()
				.toString(), spinner1.getSelectedItem().toString(), spinner2
				.getSelectedItem().toString()));
		// adicionando partida14
		partidas.add(criarPartida(14, data2.getTime(), local2.getText()
				.toString(), spinner3.getSelectedItem().toString(), spinner4
				.getSelectedItem().toString()));
		// adicionando partida15
		partidas.add(criarPartida(15, data3.getTime(), local3.getText()
				.toString(), spinner5.getSelectedItem().toString(), spinner6
				.getSelectedItem().toString()));
		// adicionando partida16
		partidas.add(criarPartida(16, data4.getTime(), local4.getText()
				.toString(), spinner7.getSelectedItem().toString(), spinner8
				.getSelectedItem().toString()));
		// adicionando partida17
		partidas.add(criarPartida(17, data5.getTime(), local5.getText()
				.toString(), spinner9.getSelectedItem().toString(), spinner10
				.getSelectedItem().toString()));
		// adicionando partida18
		partidas.add(criarPartida(18, data6.getTime(), local6.getText()
	...
	public void setData1(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener1,
	...
	public void setData2(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener2,
	...
	public void setData3(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener3,
	...
	public void setData4(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener4,
	...
	public void setData5(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener5,
	...
	public void setData6(View view) {
		new DatePickerDialog(CriarPartidaGrupoC.this, dataListener6,
